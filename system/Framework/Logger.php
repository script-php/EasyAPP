...
class Logger {
    ...
    public function __construct($logFile = null, $logLevel = 'error') {
        $this->logFile = $logFile ?: PATH . 'storage/logs/error.log';
        $this->logLevel = $logLevel;
        $this->ensureLogDirectory();
    }
    
    public static function getInstance($logFile = null, $logLevel = 'error') {
